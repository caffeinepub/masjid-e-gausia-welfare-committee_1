...
const services = [
  ...
  {
    icon: ShieldAlert,
    title: 'मुआशरे में फैली बुराइयों को खत्म करना',
    description:
      'समाज में फैली बुराइयों, अंधविश्वास, और सामाजिक कुरीतियों को जड़ से खत्म करने के लिए जागरूकता अभियान चलाए जाते हैं। नैतिक और इस्लामी मूल्यों पर आधारित समाज निर्माण हमारा लक्ष्य है।',
    color: 'text-teal-600',
    bg: 'bg-teal-50',
  },
  {
    icon: Ban,
    title: 'दहेज प्रथा रोकथाम अभियान',
    description:
      'दहेज प्रथा एक सामाजिक अभिशाप है। हम इस कुप्रथा के विरुद्ध जागरूकता फैलाते हैं और पीड़ित परिवारों को सहायता व मार्गदर्शन प्रदान करते हैं ताकि समाज से यह बुराई समाप्त हो सके।',
    color: 'text-rose-600',
    bg: 'bg-rose-50',
  },
  {
    ...
    title: 'करियर गाइडेंस',
    description:
      'युवाओं को उनके करियर के सही चुनाव में मार्गदर्शन दिया जाता है। व्यावसायिक प्रशिक्षण, रोजगार के अवसर, और कौशल विकास कार्यक्रमों के माध्यम से युवाओं को आत्मनिर्भर बनाया जाता है।',
